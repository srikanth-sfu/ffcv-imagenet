...
class EfficientNetLiteCustom(nn.Module):
    ...
    def preprocess(self):
        ...
        model.blocks[0][0].conv = nn.Conv2d(f1, f1, kernel_size=(3, 3), stride=(1,1), padding=(1, 1), bias=False)
        model.blocks[0][0].bn1 = BatchNormAct2d(f1)

        model.blocks[1][0].conv_exp = nn.Conv2d(f1, f1, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
