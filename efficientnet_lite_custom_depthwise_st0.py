...
class EfficientNetLiteCustom(nn.Module):
    ...
    def preprocess(self):
        ...
        model.blocks[0][0].conv = nn.Conv2d(f1, f1, kernel_size=(3, 3), stride=(1,1), padding=(1, 1), bias=False, groups=f1)
        ...
        model.blocks[1][0].conv_pwl = nn.Conv2d(f1, f2, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False, groups=f1)
